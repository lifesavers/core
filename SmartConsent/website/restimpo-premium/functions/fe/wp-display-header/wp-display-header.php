...
if ( ! class_exists( 'restimpo_Wp_Plugins_v301' ) )
	require_once( 'wp-display-header-functions.php' );


register_activation_hook( __FILE__, array(
	'restimpo_Wp_Display_Header',
	'activation'
) );


class restimpo_Wp_Display_Header extends restimpo_Wp_Plugins_v301 {
	 ...
	 * @access public
	 *
	 * @return restimpo_Wp_Display_Header
	 */
...
} // End of class restimpo_Wp_Display_Header.
 ...
 * @return void
 */
function restimpo_wpdh_instantiate() {

	if ( current_theme_supports( 'custom-header' ) )
		new restimpo_Wp_Display_Header;
}
add_action( 'init', 'restimpo_wpdh_instantiate', 1 );
